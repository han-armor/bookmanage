package com.youo.bookmanage.response;
...
public class Result {
    ...
    public static Result build(Boolean success,Integer code, String message) {
        return new Result(success, code, message, null);
    }
    ...
    public static Result ok(){
        Result result = new Result();        result.setSuccess(true);
